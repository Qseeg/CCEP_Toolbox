function [DataStruct, Files, StimAnnot, ImportData] = CCEPEDFDataImport(varargin)
%[DataStruct, Files, StimAnnot, ImportData] = CCEPEDFDataImport('Name', PatientName,'Data|EDF',DataFile,'Annot',AnnotFile,'Elec',ElectrodeFile)
...
% if nargout == 4
%     %Import the EDF Data
%     fprintf('Importing the EDF Data for %s',ShortFileName(DataFile));
%     ImportData = EDFLoading('File',DataFile,'Labels',{DataStruct.Uni.OriginalLabel},'Freq',DataStruct.Info.SamplingFreq);
% end
